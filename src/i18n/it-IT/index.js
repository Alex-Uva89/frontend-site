export default {
  ...
  drawer: {
    ...
    heroText: 'Ingredienti selezionati, artigianalità radicale, ospitalità contemporanea. Lecce, casa.',
    home: 'Home',
    venues: 'I nostri locali',
  ...
  pages: {
    contact: {
      title: 'Contatti',
      subtitle: 'Scrivici: ti rispondiamo il prima possibile.',
      privacy: 'Acconsento al trattamento dei dati personali',
      write: 'oppure scrivi direttamente'
    },
    jobs: {
